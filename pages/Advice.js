...
const Advice = () => {
  ...
  }), currentAdviceKey ? React.createElement("div", {
    className: "animate-fadeIn"
  }, React.createElement("h2", {
    className: "text-xl font-bold mb-2"
  }, t(`${currentAdviceKey}_title`)), React.createElement("p", {
    className: "text-gray-600 dark:text-gray-400"
  }, t(`${currentAdviceKey}_text`))) : React.createElement("p", {
    className: "text-gray-600 dark:text-gray-400"
  }, t('click_button_for_advice')))), React.createElement("div", {
    className: "mt-6"
